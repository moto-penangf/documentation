...
To fix the brick, reflash all small files from the firmware, excluding super, from SP Flash Tool or mtkclient. 
::: 
...
fastboot oem scp_log_thru_ap_uart <1/0> # Redirects SCP (I don't know what it is) to UART
