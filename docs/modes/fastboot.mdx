...
<Tabs>
    <TabItem value="0" label="Main menu" default>
        <img src="../../assets/fastboot/menu.JPG" width="300" />
    </TabItem>
    <TabItem value="1" label="Start / Factory / BpTools modes">
        <img src="../../assets/fastboot/started.JPG" width="300" />
    </TabItem>
    <TabItem value="2" label="Switch console">
        <img src="../../assets/fastboot/switch_console.JPG" width="300" />
    </TabItem>
    <TabItem value="3" label="Bootloader logs">
        <img src="../../assets/fastboot/logs.JPG" width="300" />
    </TabItem>
</Tabs>
