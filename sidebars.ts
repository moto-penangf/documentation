...
const sidebars: SidebarsConfig = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Development',
      items: ['dev/bootloader', 'dev/partitions', 'dev/testpoints', 'dev/uart',  'dev/mtkclient', 'dev/oem-key-algorithm', 'dev/touchscreen' , 'dev/logs', 'dev/decompilation', 'dev/tools']
    },
    {
      type: 'category',
      label: 'Modding',
      items: ['modding/custom-bootloader', 'modding/twrp', 'modding/root', 'modding/gsi', 'modding/disable-bootloader-warnings']
    },
    {
      type: 'category',
      label: 'GSI Roms',
